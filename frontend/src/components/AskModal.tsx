          ...
          if (match) {
            ...
            return (
              <button
                key={idx}
                type="button"
                onClick={() => setSelectedCitationId(isSelected ? null : citId)}
    ...
    >
      <div className="relative w-full max-w-3xl max-h-[90vh] bg-dark-900 border border-slate-700/80 rounded-2xl shadow-2xl flex flex-col overflow-hidden text-slate-100 font-sans">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-5 min-h-[220px]">
          {/* Loading State */}
          {loading && (
            <div className="py-12 flex flex-col items-center justify-center space-y-3 text-center animate-pulse">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5">
                    {response.citations.map((c) => {
                      ...
                      return (
                        <div
                          key={c.citation_id}
                          onClick={() => setSelectedCitationId(isSelected ? null : c.citation_id)}
